      ...
      <div className="container container--wide">
        <div className="header__inner">
          ...
          <div id="mobile-nav" className="mobile-nav">
            ...
            <div id="mobile-nav-panel-1" className="mobile-nav__panel mobile-nav__panel--primary">
              <div className="mobile-nav__menu-wrapper">
                <nav className="mobile-nav__menu">
                  <ul className="mobile-nav__list">
                    <li className="mobile-nav__item">
                      <button id="mobile-nav-toggle" className="mobile-nav__link">
                        Tools
                      </button>
                      <svg id="accordion-icon" xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10">
                        <path fill="#000" fillRule="evenodd" d="M4 10V0h2v10H4Z" clipRule="evenodd"></path>
                        <path fill="#000" fillRule="evenodd" d="M0 4h10v2H0V4Z" clipRule="evenodd"></path>
                      </svg>
                      <ul id="mobile-nav-accordion" className="mobile-nav__list mobile-nav__list--secondary">
                        <li className="mobile-nav__item">
                          <a href="/core/" className="mobile-nav__link mobile-nav__link--medium">
                            Core
                          </a>
                        </li>
                        <li className="mobile-nav__item">
                          <a href="/scroll/" className="mobile-nav__link mobile-nav__link--medium">
                            Scroll
                          </a>
                        </li>
                        <li className="mobile-nav__item">
                          <a href="/svg/" className="mobile-nav__link mobile-nav__link--medium">
                            SVG
                          </a>
                        </li>
                        <li className="mobile-nav__item">
                          <a href="/ui/" className="mobile-nav__link mobile-nav__link--medium">
                            UI
                          </a>
                        </li>
                        <li className="mobile-nav__item">
                          <a href="/text/" className="mobile-nav__link mobile-nav__link--medium">
                            Text
                          </a>
                        </li>
                      </ul>
                    ...
                    <li className="mobile-nav__item">
                      <a className="mobile-nav__link" href="/pricing/" aria-current="page">
                        Pricing
                      </a>
                    </li>
                    <li className="mobile-nav__item">
                      <a className="mobile-nav__link" href="/showcase/">
                        Showcase
                      </a>
                    </li>
                    <li className="mobile-nav__item">
                      <a className="mobile-nav__link" href="/resources/">
                        Resources
                      </a>
                    </li>
                    <li className="mobile-nav__item">
                      <a className="mobile-nav__link" href="/community/">
                        Community
                      </a>
                    </li>
                    <li className="mobile-nav__item">
                      <a className="mobile-nav__link" href="/docs/v3/">
                        Docs
                      </a>
                    </li>
                  </ul>
                  <ul className="mobile-nav__list">
                    <li className="mobile-nav__item">
                      <button id="mobile-login-open" className="mobile-nav__link mobile-nav__link--small js-guest-ui">
                        Login/Create Account
                      </button>
                    </li>
                    <li className="mobile-nav__item js-member-ui">
                      <button id="mobile-account-open" className="js-account-mobile"></button>
                    </li>
                  </ul>
                </nav>
              </div>
              <nav id="mobile-account-panel" className="mobile-nav__hidden mobile-account">
                <button id="mobile-account-close" className="mobile-account__close">
                ...
                <div className="user user--light js-account-submenu"></div>
                <ul className="mobile-account__list">
                  <li className="mobile-account__link">
                  ...
                  <li className="mobile-account__link">
                    <a className="js-logout" href="#">
                      Logout
                    </a>
                  </li>
                  <li className="mobile-account__link mobile-account__link--small mobile-account__link--messages" data-count="2">
                    <a href="/community/messenger/">Messages</a>
                  </li>
                  <li className="mobile-account__link mobile-account__link--small" data-count="2">
                    <a href="/community/notifications/">Notifications</a>
                  </li>
                </ul>
              </nav>
              <nav id="mobile-login-panel" className="mobile-nav__hidden mobile-login">
                <button id="mobile-login-close" className="mobile-login__close">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
                    <path
                      fill="#0E100F"
                      d="M9.96 5.086 3.587 11.46 3.07 12l.516.54 6.375 6.374 1.078-1.078-5.086-5.086H21v-1.5H5.953l5.086-5.086-1.078-1.078Z"></path>
                ...
                <h4 className="mobile-login__title">Sign In</h4>
                <form className="mobile-form" action="/community/login/" method="post">
                  <div className="mobile-form-group">
                    <input type="hidden" name="_processLogin" value="usernamepassword" />
                    <input type="hidden" name="csrfKey" />
                    <input type="hidden" name="remember_me" value="0" />
                    <input type="hidden" name="remember_me_checkbox" value="1" />
                    <input type="email" className="mobile-input heading-s" name="auth" placeholder="Email Address" />
                    <input type="password" className="mobile-input heading-s" name="password" placeholder="Password" />
                  </div>
                  <button type="submit" className="button button--fill" data-block="button">
                    <span className="button__flair"></span>
                    <span className="button__label">Login</span>
                  </button>
                  <a className="mobile-form__link" href="/community/lostpassword/">
                    Forgot your password?
                  </a>
                </form>
                <h4 className="mobile-login__subtitle">Not got an account?</h4>
                <a href="/community/register" className="button button--stroke" data-block="button">
                  <span className="button__flair"></span>
                  <span className="button__label">Create an Account</span>
                </a>
              </nav>
            </div>
            <div id="mobile-nav-panel-2" className="mobile-nav__panel mobile-nav__panel--secondary">
              <nav className="mobile-nav__menu">
                <ul className="mobile-nav__list">
                  <li className="mobile-nav__item">
                    <a className="mobile-nav__link mobile-nav__link--small" href="https://codepen.io/GreenSock">
                      CodePen
                    </a>
                  </li>
                  <li className="mobile-nav__item">
                    <a className="mobile-nav__link mobile-nav__link--small" href="https://github.com/greensock/GreenSock-JS/">
                      GitHub
                    </a>
                  </li>
                  <li className="mobile-nav__item">
                    <a className="mobile-nav__link mobile-nav__link--small" href="https://www.facebook.com/greensock/">
                      Facebook
                    </a>
                  </li>
                  <li className="mobile-nav__item">
                    <a className="mobile-nav__link mobile-nav__link--small" href="https://www.linkedin.com/company/greensock">
                      LinkedIn
                    </a>
                  </li>
                  <li className="mobile-nav__item">
                    <a className="mobile-nav__link mobile-nav__link--small" href="https://www.twitter.com/greensock/">
                      Twitter
                    </a>
                  </li>
                </ul>
